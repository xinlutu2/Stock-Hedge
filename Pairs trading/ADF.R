#############################################To: Gelber#################################################################
##Augmented Dicky Fuller Test for Cointegration                                                                       ##              ##
##References: http://gekkoquant.com/2012/12/17/statistical-arbitrage-testing-for-cointegration-augmented-dicky-fuller/##
########################################################################################################################
...
hedgeTrainingStartDate = as.Date("2007-01-01") #Start date for training the hedge ratio
hedgeTrainingEndDate = as.Date("2013-07-31") #End date for training the hedge ratio


symbolLst<-c("CMCSK","CMCSA")
title<-c("Comcast Corporation K vs Comcast Corporation A")
